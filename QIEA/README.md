...
→ [Read the full explanation](Classical/README.md)
...
→ [Read the full explanation](Quantum_Inspired/README.md)
...
→ [See full analysis in the Notebook](QIEA_vs_GA_Analysis/README.md)
...
# Run Classical GA
python Classical/classical_ga.py

# Run QIEA
python Quantum_Inspired/qiea.py

# Open the full comparison notebook
jupyter notebook QIEA_vs_GA_Analysis/QIEA_vs_GA_Knapsack.ipynb
```
